...
class BookSchema(ma.Schema):
    ...
    cover_image_url = fields.String(dump_only=True)
    cover_image_s3_key = fields.String(dump_only=True)
    publication_year = fields.Integer(required=False, allow_none=True)
